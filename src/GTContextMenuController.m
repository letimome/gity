...
- (void) invalidateSourceListActionsMenu {
	...
	if([gitd isHeadDetatched]) {
        ...
        [newFeature setEnabled:false];//gitline
...
- (NSMenu *) branchActionsMenu {
	...
	if([sourceListView isSelectedItemActiveBranch]) {
        ...
        [branchActionsMenu addItem:branchNewFeatureFromThis];
...
- (void) initActionsMenu {
    ...
    [actionsMenu addItem:newFeature];
...
- (void) initActionsMenuItems {
    ...
    /*GitLine*/
    newFeature = [[NSMenuItem alloc] init];
	[newFeature setTitle:@"New Feature..."];
	[newFeature setKeyEquivalent:@"f"];
	[newFeature setKeyEquivalentModifierMask:(NSShiftKeyMask | NSCommandKeyMask)];
	[newFeature setTarget:gd];
	[newFeature setAction:@selector(gitNewFeatureFromActiveBranch:)];
    ...
    newFeatureFromCommit = [[NSMenuItem alloc] init];
	[newFeatureFromCommit setTitle:@"New Feature Branch From Commit..."];
	[newFeatureFromCommit setKeyEquivalent:@"f"];
	[newFeatureFromCommit setKeyEquivalentModifierMask:(NSAlternateKeyMask)];
	[newFeatureFromCommit setEnabled:false];
...
- (void) initBranchActionItems {
    ...
    branchNewFeatureFromThis = [[NSMenuItem alloc] init];
	[branchNewFeatureFromThis setTitle:@"New Feature From Here..."];
	[branchNewFeatureFromThis setTarget:sourceListView];
	[branchNewFeatureFromThis setAction:@selector(branchNewFeatureFromHere:)];
